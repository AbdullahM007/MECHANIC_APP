...
import { View, Text, Button, StyleSheet, TouchableOpacity, Modal, ImageBackground } from 'react-native';
  ...
  return (
    <View style={styles.languageContainer}>
      ...
      <View style={styles.languageButtonsContainer}>
        ...
        <TouchableOpacity
          style={[styles.languageButton, selectedLanguage === 'ur' && styles.selectedLanguage]}
          onPress={() => onChangeLanguage('ur')}
        >
          <Text style={[styles.languageButtonText, selectedLanguage === 'ur' && styles.selectedLanguageText]}>Urdu</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
const SettingScreen = () => {
  ...
  const handleLogout = () => {
    ...
    // You can use libraries like AsyncStorage or Redux to manage user authentication.
  };
  ...
  return (
    <ImageBackground source={require('../../assets/Images/8.jpg')} style={styles.backgroundImage}>

    <View style={styles.container}>
      {/* Language Options */}
      <LanguageOptions selectedLanguage={selectedLanguage} onChangeLanguage={handleChangeLanguage} />
